...
issue_label_dict = {
    "labels": [
        {"name": "bug", "description": "Something isn't working as expected"},
        {
            "name": "enhancement",
            "description": "New feature or request for improvement",
        },
        {"name": "feature", "description": "New functionality to be added"},
        {
            "name": "documentation",
        ...
        {"name": "invalid", "description": "This doesn't seem right or relevant"},
        {"name": "priority: high", "description": "Needs to be addressed urgently"},
        {"name": "priority: low", "description": "Can be addressed later"},
        {
            "name": "in progress",
            "description": "Work on this issue is currently ongoing",
        },
        {"name": "needs review", "description": "Ready for review by maintainers"},
        {"name": "dependencies", "description": "Related to project dependencies"},
    ]
}
